            ...
            <div class="layui-col-xs9">
                ...
                <script>
                    layui.use('table', function(){
                        ...
                        table.render({
                            elem: '#test'
                            ,url:'${pageContext.request.contextPath}/user/departmentList'
...
//});
                        ...
                        table.on('tool(test)', function(obj){
                            ...
                            if(obj.event === 'del'){  //删除
                                layer.confirm('真的删除行么', function(index){
                                    obj.del();
                                    $.post("${pageContext.request.contextPath}/user/delDepartment", {id:data.departmentId})
                                    layer.close(index);
                                    //执行重载
                                    table.reload('test', {
                                        page: {
                                ...
                                window.location.href = "${pageContext.request.contextPath}//user/toupdateDepartment/"+data.departmentId;
                                layer.close(index);
                            }
                        });
                        ...
                        $('#sub').on('click', function(){
                            ...
                            table.reload('test', {
                                ...
                                , url: '${pageContext.request.contextPath}/user/searchDepartment'  //后台做模糊搜索接口路径
                                , method: 'post'
                            });
                        });
